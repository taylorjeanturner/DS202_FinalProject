...
**Taylor: **I found and suggested the data set that we used for the project. I created our team's proposal. I explored if gender played a role in type of offense. I also found another data set to help further my investigation into the distribution of gender in prisons and if either gender was over-represented in prison. For our presentation I wrote and presented the background of our dataset as well as my own findings.
...
**Jonathan: **I looked in to what differance the type of offense makes on the months served and comapred the maximums, averages and the differance between the maximum and average. I also looked what impact other data points have on months served, including offense classification, race/ethnicity and sex. I shared my findings withe my team. Finally, I presented our conclusions to the class during our presentation. 
